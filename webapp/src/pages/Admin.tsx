      ...
      {!loading && activeTab === 'products' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', paddingBottom: '7rem' }}>
            {!showAddForm && (
              ...
              >
                <PlusIcon width={32} height={32} color="var(--gold)" />
            ...
            {showAddForm && (
              <div className="glass-card slide-up" style={{ border: '1px solid var(--gold)' }}>
                <div className="flex-between" style={{ marginBottom: '1rem' }}>
                  ...
                  <button className="icon-btn secondary" onClick={closeAddForm}><XIcon width={20} height={20}/></button>
                </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              {!showAddCategoryForm && (
                ...
                >
                  <PlusIcon width={16} height={16} style={{ marginRight: '0.2rem', verticalAlign: 'middle' }} /> Добавить категорию
                </button>
              )}
            </div>
            ...
            {showAddCategoryForm && (
              <div className="glass-card slide-up" style={{ border: '1px solid var(--gold)', marginBottom: '1.5rem', padding: '1rem' }}>
                <div className="flex-between" style={{ marginBottom: '1rem' }}>
                  ...
                  <button className="icon-btn secondary" onClick={() => setShowAddCategoryForm(false)}><XIcon width={18} height={18}/></button>
                </div>
                ...
                <div className="glass-card" style={{ position: 'relative' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                      <button className="icon-btn-copy" onClick={() => handleCopy(settings.idr_account)} title="Копировать номер счета"><CopyIcon width={14} height={14}/></button>
                      <button className="icon-btn-edit" onClick={() => toggleEdit('idr')} title="Редактировать" style={{ border: isEditing ? '2px solid var(--gold)' : '1px solid var(--gold)' }}><PenIcon width={14} height={14}/></button>
                      <button className="icon-btn-delete" onClick={() => removeMethod('idr')} title="Удалить"><Trash2Icon width={14} height={14}/></button>
                    </div>
                  </div>
              ...
              return (
                <div className="glass-card" style={{ position: 'relative' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                      <button className="icon-btn-copy" onClick={() => handleCopy(settings.usdt_address)} title="Копировать адрес"><CopyIcon width={14} height={14}/></button>
                      <button className="icon-btn-edit" onClick={() => toggleEdit('usdt')} title="Редактировать" style={{ border: isEditing ? '2px solid var(--gold)' : '1px solid var(--gold)' }}><PenIcon width={14} height={14}/></button>
                      <button className="icon-btn-delete" onClick={() => removeMethod('usdt')} title="Удалить"><Trash2Icon width={14} height={14}/></button>
                    </div>
                  </div>
              ...
              return (
                <div className="glass-card" style={{ position: 'relative' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                      <button className="icon-btn-copy" onClick={() => handleCopy(settings.uah_card)} title="Копировать номер карты"><CopyIcon width={14} height={14}/></button>
                      <button className="icon-btn-edit" onClick={() => toggleEdit('uah')} title="Редактировать" style={{ border: isEditing ? '2px solid var(--gold)' : '1px solid var(--gold)' }}><PenIcon width={14} height={14}/></button>
                      <button className="icon-btn-delete" onClick={() => removeMethod('uah')} title="Удалить"><Trash2Icon width={14} height={14}/></button>
                    </div>
                  </div>
              ...
              return (
                <div className="glass-card" style={{ position: 'relative' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                      <button className="icon-btn-copy" onClick={() => handleCopy(settings.vnd_account)} title="Копировать номер счета"><CopyIcon width={14} height={14}/></button>
                      <button className="icon-btn-edit" onClick={() => toggleEdit('vnd')} title="Редактировать" style={{ border: isEditing ? '2px solid var(--gold)' : '1px solid var(--gold)' }}><PenIcon width={14} height={14}/></button>
                      <button className="icon-btn-delete" onClick={() => removeMethod('vnd')} title="Удалить"><Trash2Icon width={14} height={14}/></button>
                    </div>
                  </div>
              ...
              return (
                <div key={m} className="glass-card" style={{ position: 'relative' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                      <button className="icon-btn-copy" onClick={() => handleCopy(settings[customNumberKey])} title="Копировать реквизиты"><CopyIcon width={14} height={14}/></button>
                      <button className="icon-btn-edit" onClick={() => toggleEdit(m)} title="Редактировать" style={{ border: isEditing ? '2px solid var(--gold)' : '1px solid var(--gold)' }}><PenIcon width={14} height={14}/></button>
                      <button className="icon-btn-delete" onClick={() => removeMethod(m)} title="Удалить"><Trash2Icon width={14} height={14}/></button>
                    </div>
                  </div>
              ...
              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
                {inactiveMethods.map(m => (
                  <button key={m} className="secondary" onClick={() => addMethod(m)} style={{ padding: '0.5rem 1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: 0 }}>
                    <PlusIcon width={16} height={16} /> {m.toUpperCase()}
                  </button>
                ))}
                <button 
                  className="secondary" 
                ...
                >
                  <PlusIcon width={16} height={16} /> Добавить метод оплаты
                </button>
              </div>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.85rem' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', color: '#fff' }}>
                    ...
                    >
                      <CopyIcon width={12} height={12} color="var(--gold)" />
                    </button>
                  </span>
                </div>
